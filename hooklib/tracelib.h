...
{ \
    static TRACELIB_NAMESPACE_IDENT(TracePoint) tracePoint(TRACELIB_NAMESPACE_IDENT(TracePointType)::Watch, (verbosity), TRACELIB_CURRENT_FILE_NAME, TRACELIB_CURRENT_LINE_NUMBER, TRACELIB_CURRENT_FUNCTION_NAME, 0); \
...
{ \
    static TRACELIB_NAMESPACE_IDENT(TracePoint) tracePoint(type, (verbosity), TRACELIB_CURRENT_FILE_NAME, TRACELIB_CURRENT_LINE_NUMBER, TRACELIB_CURRENT_FUNCTION_NAME, 0); \
...
#define TRACELIB_DEBUG_IMPL TRACELIB_VISIT_TRACEPOINT_MSG(TRACELIB_NAMESPACE_IDENT(TracePointType)::Debug, 1, 0)
#define TRACELIB_ERROR_IMPL TRACELIB_VISIT_TRACEPOINT_MSG(TRACELIB_NAMESPACE_IDENT(TracePointType)::Error, 1, 0)
#define TRACELIB_TRACE_IMPL TRACELIB_VISIT_TRACEPOINT_MSG(TRACELIB_NAMESPACE_IDENT(TracePointType)::Log, 1, 0)
#define TRACELIB_WATCH_IMPL(vars) TRACELIB_VARIABLE_SNAPSHOT_MSG(1, vars, 0)
#define TRACELIB_DEBUG_MSG_IMPL(msg) TRACELIB_VISIT_TRACEPOINT_MSG(TRACELIB_NAMESPACE_IDENT(TracePointType)::Debug, 1, TRACELIB_NAMESPACE_IDENT(StringBuilder)() << msg)
#define TRACELIB_ERROR_MSG_IMPL(msg) TRACELIB_VISIT_TRACEPOINT_MSG(TRACELIB_NAMESPACE_IDENT(TracePointType)::Error, 1, TRACELIB_NAMESPACE_IDENT(StringBuilder)() << msg)
#define TRACELIB_TRACE_MSG_IMPL(msg) TRACELIB_VISIT_TRACEPOINT_MSG(TRACELIB_NAMESPACE_IDENT(TracePointType)::Log, 1, TRACELIB_NAMESPACE_IDENT(StringBuilder)() << msg)
#define TRACELIB_WATCH_MSG_IMPL(msg, vars) TRACELIB_VARIABLE_SNAPSHOT_MSG(1, vars, TRACELIB_NAMESPACE_IDENT(StringBuilder)() << msg)
